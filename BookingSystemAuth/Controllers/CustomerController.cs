...
namespace BookingSystemAuth.Controllers
{
    ...
    public class CustomerController : ApiController
    {
        ...
        // GET: api/Customer/paginate/1/10
        [Route("api/Customer/paginate/{Index:int}/{PageSize:int}")]
        [AcceptVerbs("GET")]
        public IHttpActionResult Get(int Index, int PageSize)
        {
            ...
            try
            {
                IEnumerable<Customer> customers = customerService.GetPageWise(sortByColumn, PageSize, Index, out count);
        ...
        public IHttpActionResult Delete(int CustomerId)
        {
            ...
            try
            {
                ...
                // Delete image
                imageService.DeleteImage(deletedCustomer.ImageSrc);
        ...
        public IHttpActionResult Post(int CustomerId)
        {
            ...
            try
            {
                ...
                imageService.DeleteImage(customer.ImageSrc);
